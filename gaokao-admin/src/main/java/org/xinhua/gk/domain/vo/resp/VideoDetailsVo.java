 ...
 * 录播详情Vo
 */
@ApiModel(value = "录播页详情信息")
public class VideoDetailsVo implements Serializable {

    private static final long serialVersionUID = -8662241191928652037L;
    ...
    @ApiModelProperty(value = "断点学时记录值")
